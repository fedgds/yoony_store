      ...
      <AttributeProvider>
        <section className="flex justify-between gap-7">
          <div className="flex flex-col max-w-[250px] w-full gap-5">
            ...
            <Link to={"/admin/products"} className="text-primary flex items-center gap-1.5 bg-util w-fit py-1.5 px-3 rounded-md hover:bg-primary hover:text-util transition-all">
              <svg
